...
public class MaquinaLlenadoyEnvasado {
	 ...
	 */
	private float costoLlenadoyEnvasado = 0F;
	 ...
	 */
	public void setCostoLlenadoyEnvasado(float newCostoLlenadoyEnvasado) {
		this.costoLlenadoyEnvasado = newCostoLlenadoyEnvasado;
	}
